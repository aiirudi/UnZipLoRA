    ...
    def forward(
        ...
        **cross_attention_kwargs,
        ...
        Args:
            ...
            encoder_hidden_states_content (`torch.Tensor`, *optional*):
                The hidden states of the encoder content.
            encoder_hidden_states_style (`torch.Tensor`, *optional*):
                The hidden states of the encoder style.
...
class AttnProcessor:
    ...
    Use Attention module with separate prompts input
    """
    ...
    def __call__(
        ...
        scale: float = 1.0,
        sigma_mask_content=None,
        sigma_mask_style=None, 
    ) -> torch.Tensor:
        ...
        # self-attention
        # * if self attention, all input to encoder is hidden states
        if encoder_hidden_states is None:
            encoder_hidden_states = hidden_states
            encoder_hidden_states_content = hidden_states
            encoder_hidden_states_style = hidden_states
        # * if cross attention, use different hidden states for encoder
        ...
        key = attn.to_k(encoder_hidden_states, encoder_hidden_states_content, encoder_hidden_states_style, *args)
        value = attn.to_v(encoder_hidden_states, encoder_hidden_states_content, encoder_hidden_states_style, *args)
        ...
        # linear proj
        hidden_states = attn.to_out[0](hidden_states, hidden_states, *args)
        # dropout
...
class AttnProcessor2_0:
    ...
    def __call__(
        ...
        args = () if USE_PEFT_BACKEND else (scale,)
        query = attn.to_q(hidden_states, *args, hidden_states_1=hidden_states, hidden_states_2=hidden_states,  sigma_mask_content=sigma_mask_content, sigma_mask_style=sigma_mask_style)
        ...
        key = attn.to_k(encoder_hidden_states, 
                        *args, hidden_states_1=encoder_hidden_states_content, 
                        hidden_states_2=encoder_hidden_states_style,  
                        sigma_mask_content=sigma_mask_content, sigma_mask_style=sigma_mask_style)
        value = attn.to_v(encoder_hidden_states, 
                          *args, hidden_states_1=encoder_hidden_states_content, 
                          hidden_states_2=encoder_hidden_states_style, 
                          sigma_mask_content=sigma_mask_content, sigma_mask_style=sigma_mask_style)
        ...
        # linear proj
        hidden_states = attn.to_out[0](hidden_states, *args, hidden_states_1=hidden_states, hidden_states_2=hidden_states, sigma_mask_content=sigma_mask_content, sigma_mask_style=sigma_mask_style)
        # dropout
        hidden_states = attn.to_out[1](hidden_states)
