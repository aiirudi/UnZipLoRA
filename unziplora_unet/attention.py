...
class BasicTransformerBlock(BasicTransformerBlock):
    ...
    def forward(
        ...
        encoder_hidden_states_content: Optional[torch.FloatTensor] = None, # context_prompt
        encoder_hidden_states_style: Optional[torch.FloatTensor] = None, # style_prompt
        ...
        # attn_output.shape: (batch_size, seq_len, 640)
        ...
        # hidden_state.shape  (batch_size, H * W , 640)
